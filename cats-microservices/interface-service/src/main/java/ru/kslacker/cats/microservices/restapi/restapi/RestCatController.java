...
import ru.kslacker.cats.microservices.restapi.models.cats.CatModel;
...
public class RestCatController {
	...
	public ResponseEntity<?> addFriend(
		...
		service.makeFriends(new FriendsInfo(cat1Id, cat2Id));
		return ResponseEntity.noContent().build();
	}
	...
	public ResponseEntity<?> removeFriend(
		...
		service.removeFriend(new FriendsInfo(cat1Id, cat2Id));
		return ResponseEntity.noContent().build();
	}

...
public class ObservableAccountTypeManager extends AccountTypeManagerWrapper {
	...
	public ObservableAccountTypeManager(AccountTypeManager wrapped, BiConsumer<Object, BankAccountTypeChangesEventArgs> updater) {
		super(wrapped);
	...
	public void setInterestOnBalance(UUID debitTypeId, BigDecimal interestOnBalance) {
		...
		updateHandler.invoke(
			this,
			new BankAccountTypeChangesEventArgs(getAccountType(debitTypeId), "New interest on balance is " + interestOnBalance));
	}
	...
	public void setDebtLimit(UUID creditTypeId, MoneyAmount debtLimit) {
		...
		updateHandler.invoke(this, new BankAccountTypeChangesEventArgs(getAccountType(creditTypeId), "New debt limit is " + debtLimit));
	}
	...
	public void setCharge(UUID creditTypeId, MoneyAmount charge) {
		...
		updateHandler.invoke(this, new BankAccountTypeChangesEventArgs(getAccountType(creditTypeId), "New credit charge is " + charge));
	}
	...
	public void setInterestOnBalancePolicy(UUID depositTypeId, InterestOnBalancePolicy policy) {
		...
		updateHandler.invoke(this, new BankAccountTypeChangesEventArgs(getAccountType(depositTypeId), "New interest on balance policy is here!"));
	}
	...
	public void setDepositTerm(UUID depositTypeId, Period depositTerm) {
		...
		updateHandler.invoke(this, new BankAccountTypeChangesEventArgs(getAccountType(depositTypeId), "New deposit term is " + depositTerm));
	}
	...
	public void setInterestCalculationPeriod(UUID typeId, Period interestCalculationPeriod) {
		...
		updateHandler.invoke(
			this,
			new BankAccountTypeChangesEventArgs(getAccountType(typeId), "New interest calculation period is " + interestCalculationPeriod));
	}
}

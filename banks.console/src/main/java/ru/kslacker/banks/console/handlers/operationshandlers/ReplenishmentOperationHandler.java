...
public class ReplenishmentOperationHandler extends HandlerImpl {
	...
	public ReplenishmentOperationHandler(CentralBank centralBank, BufferedReader reader, BufferedWriter writer) {
		super("replenish");
	...
	protected void handleImpl(String... args) throws IOException {
		...
		ReadOnlyOperationInformation operationInformation = centralBank.replenish(accountId, moneyAmount);
